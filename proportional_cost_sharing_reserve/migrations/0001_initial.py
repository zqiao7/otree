    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', otree.db.models.ForeignKey(related_name='proportional_cost_sharing_reserve_group', to='otree.Session')),
            ],
            options={
                'db_table': 'proportional_cost_sharing_reserve_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', otree.db.models.ForeignKey(to='proportional_cost_sharing_reserve.Group', null=True)),
                ('participant', otree.db.models.ForeignKey(related_name='proportional_cost_sharing_reserve_player', to='otree.Participant')),
                ('session', otree.db.models.ForeignKey(related_name='proportional_cost_sharing_reserve_player', to='otree.Session')),
            ],
            options={
                'db_table': 'proportional_cost_sharing_reserve_player',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('round_number', otree.db.models.PositiveIntegerField(null=True, db_index=True)),
                ('session', otree.db.models.ForeignKey(related_name='proportional_cost_sharing_reserve_subsession', to='otree.Session', null=True)),
            ],
            options={
                'db_table': 'proportional_cost_sharing_reserve_subsession',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model),
        ),
        migrations.AddField(
            model_name='player',
            name='subsession',
            field=otree.db.models.ForeignKey(to='proportional_cost_sharing_reserve.Subsession'),
        ),
        migrations.AddField(
            model_name='group',
            name='subsession',
